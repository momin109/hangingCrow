...
export const bankingAPI = {
  ...
  getTransactionHistory: (filters) =>
    apiClient.get("/payment/history", { params: filters }),
...
export const riskAPI = {
  getTopPlayers: (limit = 10) =>
    apiClient.get("/betting/risk/top-players", { params: { limit } }),
...
export const sportAPI = {
  ...
  toggleSport: (sportId, status) =>
    apiClient.patch(`/betting/sports/${sportId}`, { status }),
...
export const adminAPI = {
  ...
  updateMatchStatus: (matchId, status) =>
    apiClient.patch(`/betting/matches/${matchId}`, { status }),
  updateFancyStatus: (fancyId, status) =>
    apiClient.patch(`/betting/fancy/${fancyId}`, { status }),
